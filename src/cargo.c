...
const struct CargoDescriptor_t CargoDesc[] = {
  ...
  {.subType = kSpareCargo0, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo1, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo2, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo3, .price = DIS, .UIIcon = SID(0,0)},
  ...
  {.subType = kJelloShot, .price = 90, .UIIcon = SID(15,5)},
  ...
  {.subType = kSpareCargo4, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo5, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo6, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo7, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kProtein, .price = 120, .UIIcon = SID(3,24)},
  {.subType = kCocoBean, .price = 45, .UIIcon = SID(6,22)},
  {.subType = kChocolate, .price = 90, .UIIcon = SID(3,25)},
  {.subType = kMeatPie, .price = 125, .UIIcon = SID(8,6)},
  {.subType = kMSG, .price = 10, .UIIcon = SID(1,21)},
  {.subType = kTVDinner, .price = 150, .UIIcon = SID(9,6)},
  {.subType = kCake, .price = 270, .UIIcon = SID(2,25)},
  ...
  {.subType = kSpareCargo8, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo9, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo10, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo11, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kFooYoung, .price = 310, .UIIcon = SID(4,25)},
  ...
  {.subType = kSpareCargo13, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo14, .price = DIS, .UIIcon = SID(0,0)},
  {.subType = kSpareCargo15, .price = DIS, .UIIcon = SID(0,0)},
};
