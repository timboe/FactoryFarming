...
struct FactoryDescriptor_t FDesc[] = {
  {.subType = kVitiminFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.0f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kVitamin, .in1 = kCarrot, .in2 = kChalk, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kVegOilFac, .unlock = 1, .invert = false, .price = 0, .multi = 2.5f, .time = 1 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kOil, .in1 = kSunflower, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kCrispsFac, .unlock = 1, .invert = false, .price = 0, .multi = 3.5f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCrisps, .in1 = kOil, .in2 = kPotato, .in3 = kSalt, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEthanolFac, .unlock = 1, .invert = false, .price = 0, .multi = 3.0f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEthanol, .in1 = kWaterBarrel, .in2 = kPotato, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHardCiderFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHardCider, .in1 = kEthanol, .in2 = kApple, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kAbattoir, .unlock = 1, .invert = false, .price = 0, .multi = 2.0f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,12), .sprite = BID(0,5), .out = kMeat, .in1 = kSunflower, .in2 = kSeaweed, .in3 = kWaterBarrel, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHydrogenFac, .unlock = 1, .invert = true, .price = 0, .multi = 0.75f, .time = 1 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHydrogen, .in1 = kWaterBarrel, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHOILFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.2f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHOil, .in1 = kOil, .in2 = kHydrogen, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCornDogFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCornDog, .in1 = kHOil, .in2 = kMeat, .in3 = kCorn, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kBeerFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.5f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kBeer, .in1 = kEthanol, .in2 = kWaterBarrel, .in3 = kWheat, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kTequilaFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kTequila, .in1 = kEthanol, .in2 = kCactus, .in3 = kWaterBarrel, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHFCSFac, .unlock = 1, .invert = false, .price = 0, .multi = 0.9f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHFCS, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kGelatinFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 1 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kGelatin, .in1 = kMeat, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kJellyFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kJelly, .in1 = kGelatin, .in2 = kLime, .in3 = kHFCS, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kJelloShotFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kJelloShot, .in1 = kJelly, .in2 = kTequila, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kEmulsifierFac, .unlock = 1, .invert = false, .price = 0, .multi = 0.7f, .time = 1 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEmulsifiers, .in1 = kSeaweed, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kIceCreamFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.5f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kIceCream, .in1 = kStrawberry, .in2 = kHFCS, .in3 = kHOil, .in4 = kEmulsifiers, .in5 = kNoCargo},
  {.subType = kBatteryFarm, .unlock = 1, .invert = false, .price = 0, .multi = 1.1f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,12), .sprite = BID(0,5), .out = kEggs, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kProteinFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kProtein, .in1 = kEggs, .in2 = kSeaweed, .in3 = kChalk, .in4 = kVitamin, .in5 = kNoCargo},
  {.subType = kChocolateFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kChocolate, .in1 = kCocoBean, .in2 = kHFCS, .in3 = kHOil, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kPieFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.4f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMeatPie, .in1 = kMeat, .in2 = kGelatin, .in3 = kWheat, .in4 = kPotato, .in5 = kNoCargo},
  {.subType = kMSGFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.1f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMSG, .in1 = kWheat, .in2 = kSalt, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kTVDinnerFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.4f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kTVDinner, .in1 = kCarrot, .in2 = kMeatPie, .in3 = kMSG, .in4 = kEmulsifiers, .in5 = kNoCargo},
  {.subType = kCakeFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.4f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCake, .in1 = kHFCS, .in2 = kEggs, .in3 = kWheat, .in4 = kChocolate, .in5 = kNoCargo},
  ...
  {.subType = kCaffeineFac, .unlock = 1, .invert = true, .price = 0, .multi = 0.8f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCaffeine, .in1 = kCoffeeBean, .in2 = kCO2, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEnergyDrinkFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.4f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEnergyDrink, .in1 = kLime, .in2 = kHFCS, .in3 = kCO2, .in4 = kCaffeine, .in5 = kNoCargo},
  {.subType = kRaveJuiceFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.4f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kRaveJuice, .in1 = kHardCider, .in2 = kEnergyDrink, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kPerkPillFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPerkPills, .in1 = kCaffeine, .in2 = kChalk, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kPackagingFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.1f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPackaging, .in1 = kCactus, .in2 = kBamboo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kDessertFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kDessert, .in1 = kJelly, .in2 = kIceCream, .in3 = kApple, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCateringKitFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.3f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCateringKit, .in1 = kTVDinner, .in2 = kDessert, .in3 = kEnergyDrink, .in4 = kPackaging, .in5 = kNoCargo},
  {.subType = kChineseReayMealFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.1f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kFooYoung, .in1 = kMeat, .in2 = kEggs, .in3 = kBamboo, .in4 = kMSG, .in5 = kNoCargo},
  {.subType = kPartyPackFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.2f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPartyPack, .in1 = kFooYoung, .in2 = kCake, .in3 = kJelloShot, .in4 = kRaveJuice, .in5 = kPackaging},
  ...
  {.subType = kParfumeFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.2f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kParfume, .in1 = kSeaCucumber, .in2 = kStrawberry, .in3 = kEthanol, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kMiraclePowderFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.2f, .time = 3 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMiraclePowder, .in1 = kSeaCucumber, .in2 = kProtein, .in3 = kCocoBean, .in4 = kPerkPills, .in5 = kNoCargo},
  {.subType = kTurkishDelightFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.2f, .time = 2 * TICKS_PER_SEC, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kTurkishDelight, .in1 = kHFCS, .in2 = kRose, .in3 = kPotato, .in4 = kNoCargo, .in5 = kNoCargo},
