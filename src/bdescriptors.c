...
struct PlantDescriptor_t PDesc[] = {
  ...
  {.subType = kBambooPlant, .unlock = 1, .price = 0, .multi = 0.6f, .sprite = SID(5, 23), .time = PVFAST, .wetness = kMoist, .soil = kLoamyGround, .out = kBamboo},
...
struct UtilityDescriptor_t UDesc[] = {
  ...
  {.subType = kBuffferBox, .unlock = 1, .price = 0, .UIIcon = SID(4,15), .sprite = SID(4,15)},
  ...
  {.subType = kRetirement, .unlock = 1, .price = 0, .UIIcon = SID(10,15), .sprite = BID(4,1)},
  {.subType = kFence, .unlock = 1, .price = 0, .UIIcon = SID(12,15), .sprite = BID(0,0)},
...
struct ExtractorDescriptor_t EDesc[] = {
  ...
  {.subType = kSaltMine, .invert = false, .unlock = 1, .price = 0, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kSalt},
...
struct FactoryDescriptor_t FDesc[] = {
  ...
  {.subType = kSpareFac2, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac3, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(0,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kAbattoir, .unlock = 1, .invert = true, .price = 0, .multi = 2.0f, .time = 2, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kMeat, .in1 = kSunflower, .in2 = kSeaweed, .in3 = kWaterBarrel, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHydrogenFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.3f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHydrogen, .in1 = kWaterBarrel, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHOILFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHOil, .in1 = kOil, .in2 = kHydrogen, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kBeerFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kBeer, .in1 = kEthanol, .in2 = kWaterBarrel, .in3 = kWheat, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kHFCSFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHFCS, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac6, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac7, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEmulsifierFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEmulsifiers, .in1 = kSeaweed, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kIceCreamFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kIceCream, .in1 = kStrawberry, .in2 = kHFCS, .in3 = kHOil, .in4 = kEmulsifiers, .in5 = kNoCargo},
  {.subType = kBatteryFarm, .unlock = 1, .invert = true, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kEggs, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kPieFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMeatPie, .in1 = kMeat, .in2 = kGelatin, .in3 = kWheat, .in4 = kPotato, .in5 = kNoCargo},
  {.subType = kMSGFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMSG, .in1 = kWheat, .in2 = kSalt, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kTVDinnerFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kTVDinner, .in1 = kCarrot, .in2 = kMeatPie, .in3 = kMSG, .in4 = kEmulsifiers, .in5 = kNoCargo},
  {.subType = kCakeFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCake, .in1 = kHFCS, .in2 = kEggs, .in3 = kWheat, .in4 = kChocolate, .in5 = kNoCargo},
  {.subType = kSpareFac8, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac9, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCaffeineFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCaffeine, .in1 = kCoffeeBean, .in2 = kCO2, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEnergyDrinkFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEnergyDrink, .in1 = kLime, .in2 = kHFCS, .in3 = kCO2, .in4 = kCaffeine, .in5 = kNoCargo},
  {.subType = kRaveJuiceFac, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kRaveJuice, .in1 = kHardCider, .in2 = kEnergyDrink, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kPackagingFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPackaging, .in1 = kCactus, .in2 = kBamboo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kPartyPackFac, .unlock = 1, .invert = true, .price = 0, .multi = 1.3f, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPartyPack, .in1 = kBeer, .in2 = kCake, .in3 = kJelloShot, .in4 = kRaveJuice, .in5 = kPackaging},
  ...
  {.subType = kSpareFac15, .unlock = DIS, .invert = false, .price = DIS, .multi = 0, .time = 0, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
};
...
struct UnlockDescriptor_t UnlockDecs[] = {
  ...
  {.type = kFactory, .subType.factory = kMiraclePowderFac, .fromSelling = 700, .ofCargo = kParfume},
