...
struct FactoryDescriptor_t FDesc[] = {
  ...
  {.subType = kBatteryFarm, .unlock = 1, .invert = false, .price = 0, .multi = 1.3f, .time = 2, .UIIcon = SID(12,12), .sprite = BID(0,5), .out = kEggs, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
