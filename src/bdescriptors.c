...
struct PlantDescriptor_t PDesc[] = {
  ...
  {.subType = kCarrotPlant, .unlock = 1, .price = 5, .multi = 1.0f, .sprite = SID(10, 8), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kCarrot},
  {.subType = kPotatoPlant, .unlock = 1, .price = 10, .multi = 2.0f, .sprite = SID(14, 8), .time = PSLOW, .wetness = kWet, .soil = kPeatyGround, .out = kPotato},
  {.subType = kSparePlant0, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant1, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSunflowerPlant, .unlock = 1, .price = 50, .multi = 5.0f, .sprite = SID(15, 8), .time = PFAST, .wetness = kDry, .soil = kChalkyGround, .out = kSunflower},
  {.subType = kAppleTree, .unlock = 1, .price = 100, .multi = 2.0f, .sprite = SID(8, 8), .time = PVSLOW, .wetness = kMoist, .soil = kPeatyGround, .out = kApple},
  {.subType = kSeaweedPlant, .unlock = 1, .price = 200, .multi = 1.5f, .sprite = SID(3, 21), .time = PFAST, .wetness = kWater, .soil = kLake, .out = kSeaweed},
  {.subType = kSparePlant2, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant3, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},  
  {.subType = kCornPlant, .unlock = 1, .price = 150, .multi = 2.0f, .sprite = SID(2, 21), .time = PFAST, .wetness = kMoist, .soil = kChalkyGround, .out = kCorn},
  {.subType = kWheatPlant, .unlock = 1, .price = 300, .multi = 1.5f, .sprite = SID(11, 8), .time = PFAST, .wetness = kDry, .soil = kSiltyGround, .out = kWheat},
  {.subType = kSparePlant4, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant5, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kCactusPlant, .unlock = 1, .price = 500, .multi = 3.0f, .sprite = SID(0, 21), .time = PSLOW, .wetness = kDry, .soil = kSandyGround, .out = kCactus},
  {.subType = kLimeTree, .unlock = 1, .price = 1000, .multi = 1.3f, .sprite = SID(4, 21), .time = PVSLOW, .wetness = kMoist, .soil = kSandyGround, .out = kLime},
  {.subType = kSparePlant6, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant7, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kStrawberryPlant, .unlock = 1, .price = 1200, .multi = 4.0f, .sprite = SID(5, 21), .time = PMED, .wetness = kMoist, .soil = kClayGround, .out = kStrawberry},
  {.subType = kCocoaPlant, .unlock = 1, .price = 2500, .multi = 1.7f, .sprite = SID(7, 21), .time = PMED, .wetness = kWet, .soil = kClayGround, .out = kCocoBean},
  {.subType = kSparePlant8, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant9, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kCoffeePlant, .unlock = 1, .price = 3000, .multi = 1.6f, .sprite = SID(6, 21), .time = PSLOW, .wetness = kMoist, .soil = kLoamyGround, .out = kCoffeeBean},
  {.subType = kBambooPlant, .unlock = 1, .price = 4000, .multi = 0.6f, .sprite = SID(5, 23), .time = PVFAST, .wetness = kMoist, .soil = kLoamyGround, .out = kBamboo},
  {.subType = kSparePlant10, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant11, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},  
  {.subType = kSeaCucumberPlant, .unlock = 1, .price = 7500, .multi = 8.3f, .sprite = SID(8, 21), .time = PMED, .wetness = kWater, .soil = kOcean, .out = kSeaCucumber},
  {.subType = kRosePlant, .unlock = 1, .price = 10000, .multi = 1.4f, .sprite = SID(1, 25), .time = PMED, .wetness = kDry, .soil = kLoamyGround, .out = kRose},
  {.subType = kSparePlant12, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant13, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant14, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
  {.subType = kSparePlant15, .unlock = DIS, .price = DIS, .multi = 1.0f, .sprite = SID(0, 0), .time = PMED, .wetness = kMoist, .soil = kSiltyGround, .out = kNoCargo},
};
...
struct FactoryDescriptor_t FDesc[] = {
  ...
  {.subType = kSpareFac0, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac1, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac2, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac3, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kAbattoir, .unlock = 1, .invert = true, .price = 2000, .multi = 2.0f, .time = 4, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kMeat, .in1 = kSunflower, .in2 = kSeaweed, .in3 = kWaterBarrel, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac4, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac5, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac6, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac7, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kBatteryFarm, .unlock = 1, .invert = true, .price = 12000, .multi = 1.3f, .time = 4, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kEggs, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac8, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac9, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac10, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac11, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  ...
  {.subType = kSpareFac12, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac13, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac14, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac15, .unlock = DIS, .invert = false, .price = DIS, .multi = 1.0f, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
