...
struct FactoryDescriptor_t FDesc[] = {
  {.subType = kVitiminFac, .unlock = 1, .price = 100, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kVitamin, .in1 = kCarrot, .in2 = kChalk, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kVegOilFac, .unlock = 1, .price = 250, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kOil, .in1 = kSunflower, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac0, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac1, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCrispsFac, .unlock = 1, .price = 500, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCrisps, .in1 = kOil, .in2 = kPotato, .in3 = kSalt, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEthanolFac, .unlock = 1, .price = 750, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEthanol, .in1 = kWaterBarrel, .in2 = kPotato, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHardCiderFac, .unlock = 1, .price = 1000, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHardCider, .in1 = kEthanol, .in2 = kApple, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac2, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac3, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kAbattoir, .unlock = 1, .price = 2000, .time = 4, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kMeat, .in1 = kSunflower, .in2 = kSeaweed, .in3 = kWaterBarrel, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHydrogenFac, .unlock = 1, .price = 1500, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHydrogen, .in1 = kWaterBarrel, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHOILFac, .unlock = 1, .price = 1750, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHOil, .in1 = kOil, .in2 = kHydrogen, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCornDogFac, .unlock = 1, .price = 2500, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCornDog, .in1 = kHOil, .in2 = kMeat, .in3 = kCorn, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kBeerFac, .unlock = 1, .price = 2000, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kBeer, .in1 = kEthanol, .in2 = kWaterBarrel, .in3 = kWheat, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac4, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac5, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kTequilaFac, .unlock = 1, .price = 3000, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kTequila, .in1 = kEthanol, .in2 = kCactus, .in3 = kWaterBarrel, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kHFCSFac, .unlock = 1, .price = 4000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kHFCS, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kGelatinFac, .unlock = 1, .price = 15000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kGelatin, .in1 = kMeat, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kJellyFac, .unlock = 1, .price = 30000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kJelly, .in1 = kGelatin, .in2 = kLime, .in3 = kHFCS, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kJelloShotFac, .unlock = 1, .price = 3500, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kJelloShot, .in1 = kJelly, .in2 = kTequila, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac6, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac7, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEmulsifierFac, .unlock = 1, .price = 2000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEmulsifiers, .in1 = kSeaweed, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kIceCreamFac, .unlock = 1, .price = 10000, .time = 3, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kIceCream, .in1 = kStrawberry, .in2 = kHFCS, .in3 = kHOil, .in4 = kEmulsifiers, .in5 = kNoCargo},
  {.subType = kBatteryFarm, .unlock = 1, .price = 12000, .time = 4, .UIIcon = SID(12,12), .sprite = BID(0,6), .out = kEggs, .in1 = kCorn, .in2 = kWaterBarrel, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kProteinFac, .unlock = 1, .price = 20000, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kProtein, .in1 = kEggs, .in2 = kSeaweed, .in3 = kChalk, .in4 = kVitamin, .in5 = kNoCargo},
  {.subType = kChocolateFac, .unlock = 1, .price = 22000, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kChocolate, .in1 = kCocoBean, .in2 = kHFCS, .in3 = kHOil, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kPieFac, .unlock = 1, .price = 25000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMeatPie, .in1 = kMeat, .in2 = kGelatin, .in3 = kWheat, .in4 = kPotato, .in5 = kNoCargo},
  {.subType = kMSGFac, .unlock = 1, .price = 20000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kMSG, .in1 = kWheat, .in2 = kSalt, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kTVDinnerFac, .unlock = 1, .price = 40000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kTVDinner, .in1 = kCarrot, .in2 = kMeatPie, .in3 = kMSG, .in4 = kEmulsifiers, .in5 = kNoCargo},
  {.subType = kCakeFac, .unlock = 1, .price = 30000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCake, .in1 = kHFCS, .in2 = kEggs, .in3 = kWheat, .in4 = kChocolate, .in5 = kNoCargo},
  {.subType = kSpareFac8, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac9, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCaffeineFac, .unlock = 1, .price = 37500, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCaffeine, .in1 = kCoffeeBean, .in2 = kCO2, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kEnergyDrinkFac, .unlock = 1, .price = 50000, .time = 2, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kEnergyDrink, .in1 = kLime, .in2 = kHFCS, .in3 = kCO2, .in4 = kCaffeine, .in5 = kNoCargo},
  {.subType = kRaveJuiceFac, .unlock = 1, .price = 70000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kRaveJuice, .in1 = kHardCider, .in2 = kEnergyDrink, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kPerkPillFac, .unlock = 1, .price = 60000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPerkPills, .in1 = kCaffeine, .in2 = kChalk, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kPackagingFac, .unlock = 1, .price = 50000, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPackaging, .in1 = kCactus, .in2 = kBamboo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kDessertFac, .unlock = 1, .price = 125000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kDessert, .in1 = kJelly, .in2 = kIceCream, .in3 = kApple, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kCateringKitFac, .unlock = 1, .price = 140000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kCateringKit, .in1 = kTVDinner, .in2 = kDessert, .in3 = kEnergyDrink, .in4 = kPackaging, .in5 = kNoCargo},
  {.subType = kPartyPackFac, .unlock = 1, .price = 160000, .time = 4, .UIIcon = SID(12,10), .sprite = BID(0,4), .out = kPartyPack, .in1 = kBeer, .in2 = kCake, .in3 = kJelloShot, .in4 = kRaveJuice, .in5 = kPackaging},
  ...
  {.subType = kSpareFac14, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
  {.subType = kSpareFac15, .unlock = DIS, .price = 0, .time = 1, .UIIcon = SID(12,10), .sprite = BID(0,0), .out = kNoCargo, .in1 = kNoCargo, .in2 = kNoCargo, .in3 = kNoCargo, .in4 = kNoCargo, .in5 = kNoCargo},
