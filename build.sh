...
rm FactoryFarmingTechDemo_v1.5.pdx.zip
rm FactoryFarming_v1.5.pdx.zip
rm FactoryFarming_NoMusic_v1.5.pdx.zip

zip -r -q FactoryFarmingTechDemo_v1.5.pdx.zip FactoryFarmingTechDemo.pdx

zip -r -q FactoryFarming_v1.5.pdx.zip FactoryFarming.pdx

mv FactoryFarming.pdx/music .

zip -r -q FactoryFarming_NoMusic_v1.5.pdx.zip FactoryFarming.pdx
